 ...
 <link rel="stylesheet" href="css/style.css">
  ...
  <div class="container-fluid">
	...
	<a class="navbar-brand" href="#" id = "li"><?php echo "Logged in as : ".$user2;?></a>
		...
		<div class="col-sm-2" style="border-right: solid 2px; height: 60%;margin-bottom: 40px;background-color: #b1bafe;float: left; margin-top: 10rem; width: 400px; border-radius: 3%">	
		<h2>Search By  </h2>
		<script>
		function undisable() {
